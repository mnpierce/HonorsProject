### ALGORITHM 5 ###
'''
Uses full random generation
In order to complete the game, all 8 matches must be randomly generated in one attempt
This leads to the greatest variation in any of the algorithms as it is entirely up to chance
Can take as many as 200 weeks
While truth booth is still implemented in this algorithm, it essentially has no affect on the game as the contestants do not take the result into consideration and continue to randomly guess
'''
